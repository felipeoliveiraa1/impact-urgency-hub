...
export const CelulaMatriz = ({ cell, quadrant, onClick }: CelulaMatrizProps) => {
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        'aspect-square rounded border-2 transition-all hover:scale-105 hover:shadow-lg relative group',
